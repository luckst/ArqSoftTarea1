...
CREATE DATABASE [CrudDB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'CrudDB', FILENAME = N'C:\DataBases\DATA\CrudDB.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'CrudDB_log', FILENAME = N'C:\DataBases\DATA\CrudDB_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
